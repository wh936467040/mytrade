...
def main():
    ...
    end_date='20170428'
    w.start();
    wd = w.wss("RB1705.SHF", "open,high,low,close,volume,amt,dealnum,chg,pct_chg,close2,turn,oi,pre_settle,settle", "2017-01-25", "2017-04-30", "adjDate=0")
    #d1= wd.Data[1][0];
    #d1 =str(d1);
    ...
    #wd = w.wsd("CU1706.SHF", "changelt,mfprice,contractmultiplier,ftmargins,trade_hiscode,pre_close,open,high,low,close,volume,amt,dealnum,chg,pct_chg,close2,turn,oi,pre_settle,settle", "2017-04-01", "2017-04-30", "adjDate=0")
